...
$(function () {
    // Initialize EmailJS
    emailjs.init("UwCAMN7aPN5P_94UA");
    ...
    $(e).submit(function (r) {
        ...
        $(t).removeClass("error success").addClass("info");
        $(t).text("Sending message...");
        
        // Send via EmailJS - Use .then() and .catch() not .done() and .fail()
        emailjs.sendForm('service_8oay3w9', 'template_so8kqnp', this)
            .then(function(response) {
                // Success
                $(t).removeClass("info error").addClass("success");
                $(t).text("✅ Message sent successfully! I will get back to you soon.");
                
                // Reset form - This clears all input fields
                $("#contact-form")[0].reset();
            })
            .catch(function(error) {
                // Error
                $(t).removeClass("info success").addClass("error");
                $(t).text("❌ Failed to send. Please email me directly at ololadeakinyemi30@gmail.com");
